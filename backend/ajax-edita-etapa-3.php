...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["status_etapa_3"]) && isset($_POST["id_registro"])) {
        $id_registro = $_POST['id_registro'];
        $status_etapa_3 = $_POST["status_etapa_3"];
        
        // Atualizar o status na tabela etapas-1
        $sql_update = "UPDATE `etapa-3` SET status_etapa = '$status_etapa_3', data = NOW() WHERE id_registro = $id_registro";
