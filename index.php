            ...
            <div class="col-md-12 blocos">
                <div class="col-md-4 blocos">
                    <div class="bloco">
                        ...
                        <p class="paragrafo-bloco">Entenda o que significam os conceitos que permeiam o projeto
                            <strong>Metrópole+Iluminada</strong>.</p>
                ...
                <div class="col-md-4 blocos">
                    <div class="bloco">
                        ...
                        <p class="paragrafo-bloco">Projetos que inspiram. Conheça iniciativas de modernização da
                            iluminação em parques públicos no Brasil.</p>
                        <a class="saiba-mais" href="inspiracoes"><i class="fa-solid fa-arrow-right"></i> Saiba mais</a>
                ...
                <div class="col-md-4 blocos">
                    <div class="bloco">
                        ...
                        <p class="paragrafo-bloco">Acesse e faça o download dos documentos relacionados ao projeto
                            <strong>Metrópole+Iluminada</strong>.</p>
                        <a class="saiba-mais" href="downloads"><i class="fa-solid fa-arrow-right"></i> Saiba mais</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12 blocos">
                    ...
                    <div class="col-md-4 blocos">
                        <div class="bloco">
                            ...
                            <a href="contato"><button><i style="width: 30px;" class="fa-solid fa-arrow-right"></i>Acesso
                                    ao
                                    formulário</button></a>
                        </div>
                    </div>
